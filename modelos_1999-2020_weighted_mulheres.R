...
# Gerações
NH_G1 <- read.csv('NHS_molted_G1_FINALF.csv')
NH_G1 <- merge(NH_G1, PESO, by = "id")

NH_G2 <- read.csv('NHS_molted_G2_FINALF.csv')
NH_G2 <- merge(NH_G2, PESO, by = "id")

NH_G3 <- read.csv('NHS_molted_G3_FINALF.csv')
NH_G3 <- merge(NH_G3, PESO, by = "id")

NH_G4 <- read.csv('NHS_molted_G4_FINALF.csv')
NH_G4 <- merge(NH_G4, PESO, by = "id")

# Estado Nutricional
NH_EN1 <- read.csv('NHS_molted_EN1_FINALF.csv')
NH_EN1 <- merge(NH_EN1, PESO, by = "id")

NH_EN2 <- read.csv('NHS_molted_EN2_FINALF.csv')
NH_EN2 <- merge(NH_EN2, PESO, by = "id")

NH_EN3 <- read.csv('NHS_molted_EN3_FINALF.csv')
NH_EN3 <- merge(NH_EN3, PESO, by = "id")

NH_EN4 <- read.csv('NHS_molted_EN4_FINALF.csv')
...
media_imc_G1 # 23.277216 intercept #22.65
media_imc_G1 <- media_imc_G1 + 22.65
media_imc_G1[1] <- media_imc_G1[1] - 22.65
...
media_imc_G2 # 23.73 intercept #23.07
media_imc_G2 <- media_imc_G2 + 23.07
media_imc_G2[1] <- media_imc_G2[1] - 23.07
...
media_imc_G3 # 23.13 intercept #22.65
media_imc_G3 <- media_imc_G3 + 22.65
media_imc_G3[1] <- media_imc_G3[1] - 22.65
...
media_imc_G4 # 24.33 intercept  #23.93
media_imc_G4 <- media_imc_G4 + 23.93
media_imc_G4[1] <- media_imc_G4[1] - 23.93
media_imc_G4
...
media_imc_EN2 # 20.8470499 #20.54
media_imc_EN2 <- media_imc_EN2 + 20.54
media_imc_EN2[1] <- media_imc_EN2[1] - 20.54
media_imc_EN2
...
media_imc_EN3 # 25.5184096 intercept  #25.03
media_imc_EN3 <- media_imc_EN3 + 25.03
media_imc_EN3[1] <- media_imc_EN3[1] - 25.03
media_imc_EN3
